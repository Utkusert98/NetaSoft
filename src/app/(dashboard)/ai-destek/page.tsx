...
export default function AiDestek() {
  const [messages, setMessages] = useState<Message[]>([{
    id: "welcome",
    role: "assistant",
    content: "Merhaba! Ben NetaSoft Eczane Asistanınım. Eczane finansı, SGK yönetimi, kârlılık analizi ve stok konularında size yardımcı olabilirim.\n\nNasıl yardımcı olabilirim?",
  }]);
    ...
    <main className="page-content" style={{ display: "flex", flexDirection: "column", height: "calc(100vh - var(--header-height))", maxWidth: 900 }}>
      ...
      <div style={{ marginBottom: "var(--spacing-5)" }}>
        ...
        <p style={{ color: "var(--color-text-muted)", fontSize: "var(--font-size-sm)" }}>
          Eczane yönetimi ve finansı konularında sorularınızı yanıtlar.
        </p>
      </div>
